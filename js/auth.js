...
function renderSidebar(){
  ...
  var links=[
    ...
    {id:'equipe',label:'\u00c9quipe',badge:Object.keys(S.people||{}).filter(function(k){return S.people[k]&&S.people[k].statut!=='archive';}).length,badgeColor:'#a855f7',icon:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'},
    ...
    {id:'how-it-works',label:'Comment ça marche',badge:0,icon:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>'}
  ];
  ...
  // Lien CP Sales Coach (outil commercial d'aide à la vente téléphonique)
  h+='<a class="sidebar-link" href="cp-sales-coach/" target="_blank" rel="noopener" title="CP Sales Coach — outil d\'aide à la vente téléphonique" style="position:relative;text-decoration:none;display:flex;align-items:center;gap:12px">';
  h+='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>';
  h+='<span>Sales Coach</span>';
  h+='<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-left:auto;opacity:0.55"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>';
  h+='</a>';
  h+='</div>';
  ...
  h+='</button>';
  h+='<button onclick="clearAppCacheAndReload()" title="Vider le cache et recharger (après une mise à jour)" style="flex:1;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.06);cursor:pointer;padding:7px;border-radius:8px;transition:background .2s;display:flex;align-items:center;justify-content:center" onmouseenter="this.style.background=\'rgba(59,130,246,0.15)\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.06)\'">';
  h+='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.5)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>';
  h+='</button>';
  // Bouton : Lancer la démo (reset le dismiss flag + start tour)
  h+='<button onclick="if(typeof resetOnboardingTour===\'function\')resetOnboardingTour();if(typeof startOnboardingTour===\'function\')startOnboardingTour();" title="Lancer la démo de l\'application" style="flex:1;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.06);cursor:pointer;padding:7px;border-radius:8px;transition:background .2s;display:flex;align-items:center;justify-content:center" onmouseenter="this.style.background=\'rgba(168,85,247,0.18)\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.06)\'">';
  h+='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.5)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>';
  h+='</button>';
